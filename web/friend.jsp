    ...
    <body>
        <div id="container">
            ...
            <div id="content">
                ...
                <div id="friend-nav">
                    <p /><a id="friend-info-a" href="#" class="current-tab" onclick="showFriendInfo()">好友管理</a>
                    ...
                    <a id="my-track-a" href="#" class="not-current-tab" onclick="showMyTrack()">我的足迹</a>
                </div>
                ...
                <div id="friend-request" class="hide">
                    ...
                    <c:forEach items="${requestScope.pfriends}" var="pfriend">
                        <p>
                            ...
                            <c:if test="${param.cid == sessionScope.user['cid']}">
                                <a class="edit" href="managerfriend.do?cid=${pfriend['cid']}&&method=confirm">同意</a>
                                <a class="edit" href="managerfriend.do?cid=${pfriend['cid']}&&method=reject">拒绝</a>
                            </c:if>
                        </p>
                        <p class="endline">
                            ${pfriend["sex"]}
                    ...
                    <c:forEach items="${requestScope.wfriends}" var="wfriend">
                        <p>
                            ...
                            <c:if test="${param.cid == sessionScope.user['cid']}">
                                <a class="edit" href="managerfriend.do?cid=${wfriend['cid']}&&method=cancel">撤消</a>
                            </c:if>
                        </p>
                        <p class="endline">
                            ${wfriend["sex"]}
